...
--- | --- | ---
arbitrary-low-level-call | Auctus Options, Starstream Finance | An attacker may perform call() to an arbitrary address with controlled calldata
...
onering-finance-oracle-manipulation | Onering Finance | getSharePrice() can be manipulated via flashloan
